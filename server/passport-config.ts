...
// Google Strategy - only initialize if valid credentials are provided
...
if (googleClientId && googleClientSecret && 
  ...
  console.log('Google OAuth credentials not configured - skipping Google strategy initialization');
}
